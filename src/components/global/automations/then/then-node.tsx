...
// component for displaying automation details in a structured node. It conditionally renders based on listener data and includes a connection indicator, listener type display, and optional post action.
