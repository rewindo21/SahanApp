...
const DoubleGradientCard = ({ description, label, subLabel }: Props) => {
  return (
    <div className="relative border-[1px] justify-between border-in-active/50 p-5 rounded-xl flex flex-col gap-y-20 overflow-hidden">
      ...
      <div className="flex justify-between items-center z-40 gap-x-10">
        ...
        <Button className="rounded-full bg-[#17665A] hover:bg-[#0B332D] w-10 h-10">
